...
**When ending a work session**, you MUST complete ALL steps below. Work is NOT complete until `git push origin HEAD` succeeds.
...
- Work is NOT complete until `git push origin HEAD` succeeds
